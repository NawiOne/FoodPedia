...
import {Text, View, ScrollView, Image, ImageBackground, TextInput, TouchableOpacity, ActivityIndicator} from 'react-native';
        ...
        <ImageBackground source={background} style={style.image}>
          <View style={style.content}>
            <View style={style.form}>
              ...
              {auth.isPending ? <ActivityIndicator color="red" style={style.indicator} size="large" /> : null}
              {msg === null ? null : (
                <View style={style.error}>
                  <Text style={style.errText}>{msg}</Text>
                </View>
              )}
              <TextInput placeholder="username" style={style.input} onChangeText={(text) => setUser(text)} value={user} />
              <TextInput
                value={password}
